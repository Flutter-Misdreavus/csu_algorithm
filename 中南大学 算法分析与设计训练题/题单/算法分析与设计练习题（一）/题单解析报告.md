...
- **题目总数**：11 道
- **核心算法思想**：线性结构（队列、栈、链表）、基础图论与字符串、枚举与模拟、分治与二分查找
...
- **字符串匹配**：KMP（P3375）
- **图论基础**：DFS 反向图（P3916）、Dijkstra 最短路（P3371）
...
- **图论基础**：P3371 的 Dijkstra 算法和 P3916 的反向图技巧，展示了图论中贪心策略和逆向思维的运用。
...
| 图论 | P3371, P3916 | 贪心（Dijkstra）和逆向思维（反向图） |
